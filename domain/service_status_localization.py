...
class ServiceStatus(StrEnum):
    ...
    SPEECH_WINDOWS_FEMALE_VOICE_MISSING = "speech_windows_female_voice_missing"
    ...
    SPEECH_WINDOWS_SYNTHESIS_TIMEOUT = "speech_windows_synthesis_timeout"
    ...
    SPEECH_OPENAI_KEY_MISSING_SENTENCE = "speech_openai_key_missing_sentence"
    SPEECH_WINDOWS_FALLBACK_DISABLED = "speech_windows_fallback_disabled"
    SPEECH_RECORDING = "speech_recording"
    SPEECH_RECOGNITION_START_FAILED = "speech_recognition_start_failed"
    SPEECH_WINDOWS_LISTENING = "speech_windows_listening"
    SPEECH_WINDOWS_FALLBACK = "speech_windows_fallback"
    SPEECH_RECORDING_COMPONENT_MISSING = "speech_recording_component_missing"
    ...
    SPEECH_WINDOWS_RECOGNIZER_MISSING = "speech_windows_recognizer_missing"
    SPEECH_WINDOWS_MICROPHONE_DENIED = "speech_windows_microphone_denied"
    SPEECH_WINDOWS_RECOGNITION_ERROR = "speech_windows_recognition_error"
    SPEECH_WINDOWS_RECOGNITION_START_ERROR = "speech_windows_recognition_start_error"
