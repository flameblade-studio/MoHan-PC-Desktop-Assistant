...
# The root-facade retirement (2026-08-28) removed every compatibility shim
# from the repository root: consumers now import the canonical layered
# modules directly.  Only two root modules remain by design: ``app`` is the
# composition root, and ``version_info`` is the packaged-runtime facade that
# the release workflow and frozen executables resolve at the bundle root.
