...
2. 執行 `MoHan-Desktop-Assistant-2.3.0-rc.3.exe`。
...
2. 运行 `MoHan-Desktop-Assistant-2.3.0-rc.3.exe`。
...
2. Run `MoHan-Desktop-Assistant-2.3.0-rc.3.exe`.
...
2. `MoHan-Desktop-Assistant-2.3.0-rc.3.exe` を実行します。
