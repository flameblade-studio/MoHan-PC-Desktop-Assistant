...
2. 執行 `MoHan-Desktop-Assistant-2.1.0-rc.1.exe`。
...
2. 运行 `MoHan-Desktop-Assistant-2.1.0-rc.1.exe`。
...
2. Run `MoHan-Desktop-Assistant-2.1.0-rc.1.exe`.
...
2. `MoHan-Desktop-Assistant-2.1.0-rc.1.exe` を実行します。
