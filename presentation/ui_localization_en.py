...
ENGLISH_UI_TEXT: Mapping[str, str] = deep_freeze({
    ...
    "nav_realm_machine": "System",
    "nav_realm_other": "More",
    "draft_bar_clean": "Applied",
    ...
    "wardrobe_quality_low": "Fast (lower quality, cheapest and quickest)",
    "wardrobe_quality_medium": "Standard (recommended)",
    "wardrobe_quality_high": "Fine (slowest and most costly)",
