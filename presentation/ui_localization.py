...
{'first_run_title': '首次启动设置',
 ...
 'draft_bar_error': '读取失败',
 'draft_bar_error_message': '设置无法读取，请稍后再试',
 'tab_wardrobe': '云裳阁',
 ...
 'wardrobe_body_profile_outdated': '这套服装是为一代素体制作的，穿在二代素体上会对不准；请用一键制衣重新生成',
 ...
 'wardrobe_preview_fallback': '造型预览暂时无法合成，当前显示素体；桌面伴侣不受影响。',
 ...
 'wardrobe_makeup_none': '素颜（不上妆）',
 'wardrobe_makeup_variant_classic': '原妆',
 ...
 'wardrobe_makeup_read_failed': '妆容设置无法读取，已保留上一个有效值。',
 'wardrobe_makeup_applied': '已应用所选妆容。',
 'wardrobe_makeup_cleared': '已卸妆，回到素颜。',
 'wardrobe_makeup_pack_missing': '所选妆容的套件已不存在，已改回内置原妆。',
 'wardrobe_makeup_unavailable': '这组妆容目前无法应用，已保留当前妆容。',
...
_JAPANESE: Mapping[str, str] = deep_freeze({
    **JAPANESE_UI,
    'tab_wardrobe': '雲裳閣',
     ...
     'wardrobe_body_profile_outdated': 'この衣装は第一世代素体向けに作られたもので、第二世代素体では位置が合いません。ワンクリック衣装生成で作り直してください',
     ...
     'wardrobe_preview_fallback': 'スタイルプレビューを合成できず、現在は素体を表示しています。デスクトップの伴侶には影響しません。',
     ...
     'wardrobe_makeup_none': 'すっぴん（メイクなし）',
     ...
     'wardrobe_makeup_read_failed': 'メイク設定を読み取れないため、最後に有効だった値を保持しました。',
     ...
     'wardrobe_makeup_unavailable': 'このメイクは現在適用できないため、現在のメイクを維持しました。',
